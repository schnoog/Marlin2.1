...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN FAN2_PIN       //PC5    // Set a custom pin for the controller fan
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN   //PC4 Open: M106 P1 S255, Close: M107
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_NAME_1 "V-Links"
  #define TRAMMING_POINT_NAME_2 "V-Rechts"
  #define TRAMMING_POINT_NAME_3 "H-Rechts"
  #define TRAMMING_POINT_NAME_4 "H-Links"
